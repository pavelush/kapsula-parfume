...
export default function Footer() {
    ...
    return (
        <footer id="contacts" style={{ background: 'var(--color-bg-secondary)', padding: '5rem 5% 2rem', borderTop: '1px solid var(--glass-border)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div className="container" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', gap: '4rem', marginBottom: '4rem' }}>
                <div>
                ...
                <div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', color: 'var(--color-text-muted)' }}>
                        <a href={`tel:${settings.contact_phone.replace(/[^0-9+]/g, '')}`} style={{ fontSize: '1.3rem', color: 'white', fontWeight: 600, textDecoration: 'none' }}>{settings.contact_phone}</a>
