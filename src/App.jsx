      ...
      <header className={`header ${scrolled ? 'scrolled' : ''}`}>
        <nav>
          <div className="logo" style={{ display: 'flex', alignItems: 'center' }}>
            <img src="/images/logo/logo.png" alt="Kapsula Parfume Logo" style={{ height: '45px', filter: isLightMode ? 'none' : 'drop-shadow(0 0 10px rgba(255,255,255,0.2))', transition: 'all 0.3s ease' }} />
          </div>

          <div className={`nav-links ${mobileMenuOpen ? 'mobile-active' : ''}`}>
            <a href="#catalog" onClick={() => setMobileMenuOpen(false)}>Каталог</a>
            <a href="#about" onClick={() => setMobileMenuOpen(false)}>Преимущества</a>
        ...
        <section className="hero">
          ...
          <div className="hero-content">
            ...
            <div className="hero-actions fade-in-up delay-2">
              ...
              <a href="#about" className="btn-secondary" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
                О нас
              </a>
            </div>
          </div>
        ...
        <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '4rem', marginBottom: '4rem' }}>
          <div>
            <div className="logo" style={{ marginBottom: '1.5rem' }}>
              <img src="/images/logo/logo.png" alt="Kapsula Parfume Logo" style={{ height: '55px', filter: isLightMode ? 'none' : 'drop-shadow(0 0 10px rgba(255,255,255,0.2))', transition: 'all 0.3s ease' }} />
            </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', color: 'var(--color-text-muted)' }}>
              ...
              <a href="#about" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><ChevronRight size={14} /> Преимущества</a>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', color: 'var(--color-text-muted)' }}>
              <a href="tel:+79162035494" style={{ fontSize: '1.3rem', color: 'white', fontWeight: 600 }}>+7 916 203 54 94</a>
              <p>Россия, Москва, ТЦ Авиапарк (1 этаж)</p>
              <p style={{ display: 'inline-block', padding: '5px 15px', background: 'rgba(255,255,255,0.05)', borderRadius: '20px', fontSize: '0.9rem', width: 'fit-content' }}>Ежедневно 10:00 - 22:00</p>

              <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                <a href="https://t.me/kapsulaparfum" target="_blank" rel="noopener noreferrer" className="btn-icon" style={{ width: '40px', height: '40px' }} title="Telegram">
                ...
                <a href="https://www.instagram.com/kapsula.parfum" target="_blank" rel="noopener noreferrer" className="btn-icon" style={{ width: '40px', height: '40px' }} title="Instagram">
                ...
                <a href="https://vk.ru/kapsula.parfum" target="_blank" rel="noopener noreferrer" className="btn-icon" style={{ width: '40px', height: '40px' }} title="VKontakte">
