            ...
            <main className="container" style={{ padding: '4rem 5%', maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div className="glass-card" style={{ padding: '3rem', fontSize: '1.05rem', lineHeight: '1.8', color: 'rgba(255,255,255,0.85)' }}>
                    ...
                    <ul style={{ paddingLeft: '20px', marginBottom: '2rem' }}>
                        ...
                        <li>4.3. Оплата считается произведённой с момента поступления денежных средств на расчётный счёт Продавца или подтверждения платёжной системой.</li>
                    </ul>
                    ...
                    <ul style={{ paddingLeft: '20px', marginBottom: '2rem' }}>
                        ...
                        <li>6.3. Возврат денежных средств за Товар ненадлежащего качества или при отказе до передачи осуществляется в течение 10 (десяти) дней с момента получения Продавцом заявления и возвращённого Товара (при необходимости).</li>
                    </ul>
