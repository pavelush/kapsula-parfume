                ...
                <section id="payment" style={{ marginBottom: '6rem' }}>
                    ...
                    <div className="glass-card" style={{ padding: '2.5rem', lineHeight: '1.8', borderRadius: '24px' }}>
                        ...
                        <div style={{ marginTop: '2.5rem' }}>
                            <h4 style={{ color: 'white', marginBottom: '1rem', fontSize: '1.2rem' }}>Безопасность платежей</h4>
                            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem', marginBottom: '1rem' }}>
                                Оплата по банковским картам производится путем переадресации на сайт системы электронных платежей ЮKassa (или авторизационный сервер Банка). Вся процедура оплаты проходит на защищенной странице процессингового центра. 
                            </p>
                            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem', marginBottom: '1rem' }}>
                                Данные Вашей платежной карты (номер, срок действия, CVC/CVV код) гарантированно защищены и не передаются интернет-магазину. Передача информации происходит с применением технологии шифрования SSL по закрытым банковским сетям высшей степени защиты.
                            </p>
                            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem' }}>
                                ООО "КАПСУЛА" не собирает, не хранит и не обрабатывает данные Ваших банковских карт. Все операции проводятся строго в соответствии с требованиями международных платежных систем и законодательством РФ.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section id="returns" style={{ marginBottom: '4rem' }}>
                    ...
                    <div className="glass-card" style={{ padding: '2.5rem', lineHeight: '1.8', borderRadius: '24px' }}>
                        ...
                        <div style={{ marginTop: '2.5rem', padding: '1.5rem', background: 'rgba(255,255,255,0.02)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                            <h4 style={{ color: 'white', marginBottom: '1rem', fontSize: '1.1rem' }}>Порядок возврата денежных средств</h4>
                            <p style={{ color: 'var(--color-text-muted)', fontSize: '0.95rem' }}>
                                Возврат переведенных средств (при отмене заказа или возврате товара) производится исключительно на Ваш банковский счет / банковскую карту, с которой была произведена оплата. Срок поступления денежных средств на счет составляет от 5 до 30 рабочих дней и зависит от Банка, выпустившего Вашу карту.
                            </p>
                        </div>
                    </div>
                </section>
